...
package.preload["fennel.repl"] = package.preload["fennel.repl"] or function(...)
  ...
  local function default_on_error(errtype, err)
    local function _660_()
      local _659_0 = errtype
      if (_659_0 == "Runtime") then
  ...
  local function splice_save_locals(env, lua_source, scope)
    ...
    local function _669_()
      local _667_0, _668_0 = lua_source:match("^(.*)[\n ](return .*)$")
      if ((nil ~= _667_0) and (nil ~= _668_0)) then
        local body = _667_0
        local _return = _668_0
  ...
  local function completer(env, scope, text, _3ffulltext, _from, _to)
    ...
    local function add_partials(input, tbl, prefix)
      ...
      for k, is_mangled in utils.allpairs(_671_()) do
    ...
    do
      local _680_0 = tostring((_3ffulltext or text)):match("^%s*,([^%s()[%]]*)$")
      if (nil ~= _680_0) then
        local cmd_fragment = _680_0
  ...
  local function reload(module_name, env, on_values, on_error)
    local _684_0, _685_0 = pcall(specials["load-code"]("return require(...)", env), module_name)
    if ((_684_0 == true) and (nil ~= _685_0)) then
      local old = _685_0
      local _ = nil
      ...
      local new = nil
      do
        local _686_0, _687_0 = pcall(require, module_name)
        if ((_686_0 == true) and (nil ~= _687_0)) then
          local new0 = _687_0
          new = new0
        elseif (true and (nil ~= _687_0)) then
          local _0 = _686_0
          local msg = _687_0
          on_error("Repl", msg)
          new = old
      ...
      return on_values({"ok"})
    elseif ((_684_0 == false) and (nil ~= _685_0)) then
      local msg = _685_0
      ...
      elseif specials["macro-loaded"][module_name] then
        ...
        local function _692_()
          local _691_0 = msg:gsub("\n.*", "")
          return _691_0
        end
        return on_error("Runtime", _692_())
      end
    end
  end
  local function run_command(read, on_error, f)
    local _695_0, _696_0, _697_0 = pcall(read)
    if ((_695_0 == true) and (_696_0 == true) and (nil ~= _697_0)) then
      local val = _697_0
      local _698_0, _699_0 = pcall(f, val)
      if ((_698_0 == false) and (nil ~= _699_0)) then
        local msg = _699_0
        return on_error("Runtime", msg)
      end
    elseif (_695_0 == false) then
      return on_error("Parse", "Couldn't parse input.")
    end
  end
  commands.reload = function(env, read, on_values, on_error)
    local function _702_(_241)
  ...
  commands.complete = function(env, read, on_values, on_error, scope, chars)
    ...
    return run_command(read, on_error, _703_)
  end
  ...
  local function apropos_2a(pattern, tbl, prefix, seen, names)
    for name, subtbl in pairs(tbl) do
      if (("string" == type(name)) and (package ~= subtbl)) then
        local _704_0 = type(subtbl)
        if (_704_0 == "function") then
          if ((prefix .. name)):match(pattern) then
            table.insert(names, (prefix .. name))
          end
        elseif (_704_0 == "table") then
          if not seen[subtbl] then
            ...
            apropos_2a(pattern, subtbl, (prefix .. name:gsub("%.", "/") .. "."), _706_, names)
          end
        end
      end
    end
  ...
  commands.apropos = function(_env, read, on_values, on_error, _scope)
    local function _711_(_241)
      return on_values(apropos(tostring(_241)))
    end
    return run_command(read, on_error, _711_)
  end
    ...
    for _, path in ipairs(apropos(".*")) do
      ...
      do
        ...
        if ("function" == type(tgt)) then
          local _715_0 = (compiler.metadata):get(tgt, "fnl/docstring")
          if (nil ~= _715_0) then
            local docstr = _715_0
  ...
  commands["apropos-show-docs"] = function(_env, read, on_values, on_error)
    local function _721_(_241)
      return apropos_show_docs(on_values, tostring(_241))
    end
    return run_command(read, on_error, _721_)
  end
  ...
  local function resolve(identifier, _722_0, scope)
    local _723_ = _722_0
    local env = _723_
    local ___replLocals___ = _723_["___replLocals___"]
    local e = nil
    local function _724_(_241, _242)
      return (___replLocals___[scope.unmanglings[_242]] or env[_242])
    end
    e = setmetatable({}, {__index = _724_})
    local function _725_(...)
      ...
      if ((_726_0 == true) and (nil ~= _727_0)) then
        ...
        return _728_(pcall(specials["load-code"](code, e)))
      else
        local _ = _726_0
        return nil
      end
    end
    return _725_(pcall(compiler["compile-string"], tostring(identifier), {scope = scope}))
  end
  commands.find = function(env, read, on_values, on_error, scope)
    local function _733_(_241)
      local _734_0 = nil
      do
        local _735_0 = utils["sym?"](_241)
        if (nil ~= _735_0) then
          local _736_0 = resolve(_735_0, env, scope)
          if (nil ~= _736_0) then
            _734_0 = debug.getinfo(_736_0)
          else
            _734_0 = _736_0
          end
        else
      ...
      if ((_G.type(_734_0) == "table") and (nil ~= _734_0.linedefined) and (nil ~= _734_0.short_src) and (nil ~= _734_0.source) and (_734_0.what == "Lua")) then
        local line = _734_0.linedefined
        local src = _734_0.short_src
        local source = _734_0.source
        local fnlsrc = nil
        do
          local _739_0 = compiler.sourcemap
          if (nil ~= _739_0) then
            _739_0 = _739_0[source]
          end
          if (nil ~= _739_0) then
            _739_0 = _739_0[line]
          end
  ...
  commands.compile = function(_, read, on_values, on_error, _0, _1, opts)
    local function _747_(_241)
      local _748_0, _749_0 = pcall(compiler.compile, _241, opts)
      if ((_748_0 == true) and (nil ~= _749_0)) then
        local result = _749_0
        return on_values({result})
      elseif (true and (nil ~= _749_0)) then
        local _2 = _748_0
        local msg = _749_0
  ...
  local function load_plugin_commands(plugins)
    for i = #(plugins or {}), 1, -1 do
      for name, f in pairs(plugins[i]) do
        local _751_0 = name:match("^repl%-command%-(.*)")
        if (nil ~= _751_0) then
          local cmd_name = _751_0
          commands[cmd_name] = f
        end
      end
    end
  ...
  local function run_command_loop(input, read, loop, env, on_values, on_error, scope, chars, opts)
    ...
    do
      local _753_0 = commands[command_name]
      if (nil ~= _753_0) then
        local command = _753_0
  ...
  local function repl(_3foptions)
    ...
    local _762_ = utils.copy(_3foptions)
    local opts = _762_
    local _3ffennelrc = _762_["fennelrc"]
    local _ = nil
    opts.fennelrc = nil
    _ = nil
    ...
    local function _764_(_241)
      return callbacks.readChunk(_241)
    end
    byte_stream, clear_stream = parser.granulate(_764_)
    local chars = {}
    local read, reset = nil, nil
    local function _765_(parser_state)
    ...
    read, reset = parser.parser(_765_)
    depth = (depth + 1)
    ...
    if opts.registerCompleter then
      local function _771_()
        local _770_0 = opts.scope
        local function _772_(...)
          return completer(env, _770_0, ...)
        end
        return _772_
      end
      opts.registerCompleter(_771_())
    end
      ...
      elseif command_3f(src_string) then
        ...
        if not_eof_3f then
          local function _776_(...)
            local _777_0, _778_0 = ...
            if ((_777_0 == true) and (nil ~= _778_0)) then
              local src = _778_0
              local function _779_(...)
                ...
                if ((_780_0 == true) and (nil ~= _781_0)) then
                  ...
                  return xpcall(_782_, _783_)
                elseif ((_780_0 == false) and (nil ~= _781_0)) then
                  local msg = _781_0
                  clear_stream()
              ...
              return _779_(_786_(...))
            elseif ((_777_0 == false) and (nil ~= _778_0)) then
              local msg = _778_0
              clear_stream()
              return callbacks.onError("Compile", msg)
            end
          ...
          _776_(pcall(compiler.compile, form, _788_()))
  ...
  local function _794_(overrides, _3fopts)
    return repl(utils.copy(_3fopts, utils.copy(overrides)))
  end
  return setmetatable({}, {__call = _794_, __index = {repl = repl}})
end
package.preload["fennel.specials"] = package.preload["fennel.specials"] or function(...)
  ...
  local function define_arithmetic_special(name, zero_arity, unary_prefix, _3flua_name)
    local _565_
    do
      local _564_0 = (_3flua_name or name)
      local function _566_(...)
        return operator_special(_564_0, zero_arity, unary_prefix, ...)
      end
      _565_ = _566_
    end
    SPECIALS[name] = _565_
  ...
  local function bitop_special(native_name, lib_name, zero_arity, unary_prefix, ast, scope, parent)
    if (#ast == 1) then
      ...
      for i = 2, len do
        ...
        subexprs = compiler.compile1(ast[i], scope, parent, {nval = _567_})
  ...
  SPECIALS.bnot = function(ast, scope, parent)
    compiler.assert((#ast == 2), "expected one argument", ast)
    local _575_ = compiler.compile1(ast[2], scope, parent, {nval = 1})
    local value = _575_[1]
    if utils.root.options.useBitLib then
  ...
  local function native_comparator(op, _577_0, scope, parent)
    local _578_ = _577_0
    local _ = _578_[1]
    local lhs_ast = _578_[2]
    local rhs_ast = _578_[3]
    local _579_ = compiler.compile1(lhs_ast, scope, parent, {nval = 1})
    local lhs = _579_[1]
    local _580_ = compiler.compile1(rhs_ast, scope, parent, {nval = 1})
    local rhs = _580_[1]
  ...
  local function binding_comparator(op, chain_op, ast, scope, parent)
    ...
    return ("(" .. table.concat(_584_, chain) .. ")")
  end
  local function define_comparator_special(name, _3flua_op, _3fchain_op)
    do
      ...
      local function opfn(ast, scope, parent)
        ...
        local _586_0 = comparator_special_type(ast)
        if (_586_0 == "native") then
          return native_comparator(op, ast, scope, parent)
        elseif (_586_0 == "idempotent") then
          return idempotent_comparator(op, _3fchain_op, ast, scope, parent)
        elseif (_586_0 == "binding") then
  ...
  local function make_compiler_env(ast, scope, parent, _3fopts)
    local provided = nil
    do
      local _594_0 = (_3fopts or utils.root.options)
      if ((_G.type(_594_0) == "table") and (_594_0["compiler-env"] == "strict")) then
        provided = safe_compiler_env()
      elseif ((_G.type(_594_0) == "table") and (nil ~= _594_0.compilerEnv)) then
        local compilerEnv = _594_0.compilerEnv
        provided = compilerEnv
      elseif ((_G.type(_594_0) == "table") and (nil ~= _594_0["compiler-env"])) then
        local compiler_env = _594_0["compiler-env"]
    ...
    local function _597_(symbol)
      compiler.assert(compiler.scopes.macro, "must call from macro", ast)
      return compiler.scopes.macro.manglings[tostring(symbol)]
    end
    local function _598_(base)
      return utils.sym(compiler.gensym((compiler.scopes.macro or scope), base))
    end
    local function _599_(form)
      compiler.assert(compiler.scopes.macro, "must call from macro", ast)
      return compiler.macroexpand(form, compiler.scopes.macro)
    end
    env = {["assert-compile"] = compiler.assert, ["ast-source"] = utils["ast-source"], ["comment?"] = utils["comment?"], ["fennel-module-name"] = fennel_module_name, ["get-scope"] = _596_, ["in-scope?"] = _597_, ["list?"] = utils["list?"], ["macro-loaded"] = macro_loaded, ["multi-sym?"] = utils["multi-sym?"], ["sequence?"] = utils["sequence?"], ["sym?"] = utils["sym?"], ["table?"] = utils["table?"], ["varg?"] = utils["varg?"], _AST = ast, _CHUNK = parent, _IS_COMPILER = true, _SCOPE = scope, _SPECIALS = compiler.scopes.global.specials, _VARARG = utils.varg(), comment = utils.comment, gensym = _598_, list = utils.list, macroexpand = _599_, sequence = utils.sequence, sym = utils.sym, unpack = unpack, version = utils.version, view = view}
    env._G = env
  ...
  local _602_ = _600_(...)
  local dirsep = _602_[1]
  local pathsep = _602_[2]
  local pathmark = _602_[3]
  ...
  local function search_module(modulename, _3fpathstring)
    ...
    local function try_path(path)
      ...
      local _603_0 = (io.open(filename) or io.open(filename2))
      if (nil ~= _603_0) then
        local file = _603_0
        file:close()
        return filename
    ...
    local function find_in_path(start, _3ftried_paths)
      local _605_0 = fullpath:match(pattern, start)
      if (nil ~= _605_0) then
        local path = _605_0
        local _606_0, _607_0 = try_path(path)
        if (nil ~= _606_0) then
          local filename = _606_0
          return filename
        elseif ((_606_0 == nil) and (nil ~= _607_0)) then
          local error = _607_0
          local function _609_()
            local _608_0 = (_3ftried_paths or {})
            table.insert(_608_0, error)
            return _608_0
          end
          return find_in_path((start + #path + 1), _609_())
        end
      else
        local _ = _605_0
  ...
  local function make_searcher(_3foptions)
    local function _614_(module_name)
      local opts = utils.copy(utils.root.options)
      for k, v in pairs((_3foptions or {})) do
        opts[k] = v
      end
      opts["module-name"] = module_name
      local _615_0, _616_0 = search_module(module_name)
      if (nil ~= _615_0) then
        local filename = _615_0
        local function _617_(...)
          return utils["fennel-module"].dofile(filename, opts, ...)
        end
        return _617_, filename
      elseif ((_615_0 == nil) and (nil ~= _616_0)) then
        local error = _616_0
        return error
      end
    end
  ...
  local function fennel_macro_searcher(module_name)
    local opts = nil
    do
      local _619_0 = utils.copy(utils.root.options)
      _619_0["module-name"] = module_name
      _619_0["env"] = "_COMPILER"
      _619_0["requireAsInclude"] = false
      _619_0["allowedGlobals"] = nil
      opts = _619_0
    end
    local _620_0 = search_module(module_name, utils["fennel-module"]["macro-path"])
    if (nil ~= _620_0) then
      local filename = _620_0
      local _621_
      ...
      return _621_, filename
    end
  end
  local function lua_macro_searcher(module_name)
    local _626_0 = search_module(module_name, package.path)
    if (nil ~= _626_0) then
      ...
      do
        ...
        code = close_handlers_10_(_G.xpcall(_628_, (package.loaded.fennel or debug).traceback))
      end
  ...
  local function search_macro_module(modname, n)
    local _630_0 = macro_searchers[n]
    if (nil ~= _630_0) then
      local f = _630_0
      local _631_0, _632_0 = f(modname)
      if ((nil ~= _631_0) and true) then
        local loader = _631_0
        local _3ffilename = _632_0
  ...
  local function sandbox_fennel_module(modname)
    if ((modname == "fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
      local function _635_(_, ...)
        return (compiler.metadata):setall(...)
      end
      return {metadata = {setall = _635_}, view = view}
    end
  end
  local function _637_(modname)
    ...
    return (macro_loaded[modname] or sandbox_fennel_module(modname) or _638_())
  end
  safe_require = _637_
  ...
  local function resolve_module_name(_639_0, _scope, _parent, opts)
    local _640_ = _639_0
    local second = _640_[2]
    local filename = _640_["filename"]
  ...
  local function include_path(ast, opts, path, mod, fennel_3f)
    ...
    do
      ...
      src = close_handlers_10_(_G.xpcall(_646_, (package.loaded.fennel or debug).traceback))
    end
  ...
  SPECIALS.include = function(ast, scope, parent, opts)
    ...
    local modexpr = nil
    do
      local _649_0, _650_0 = pcall(resolve_module_name, ast, scope, parent, opts)
      if ((_649_0 == true) and (nil ~= _650_0)) then
        local modname = _650_0
    ...
    if ((modexpr.type ~= "literal") or ((modexpr[1]):byte() ~= 34)) then
      ...
      local function _654_()
        local _653_0 = search_module(mod)
        if (nil ~= _653_0) then
          local fennel_path = _653_0
      ...
      res = ((utils["member?"](mod, (utils.root.options.skipInclude or {})) and opts.fallback(modexpr, true)) or include_circular_fallback(mod, modexpr, opts.fallback, ast) or utils.root.scope.includes[mod] or _654_())
...
local function eval(str, _3foptions, ...)
  ...
  loader = specials["load-code"](lua_source, env, _800_(...))
  opts.filename = nil
  return loader(...)
end
...
local function syntax()
  ...
  for k, v in pairs(_G) do
    local _801_0 = type(v)
    if (_801_0 == "function") then
      out[k] = {["function?"] = true, ["global?"] = true}
    elseif (_801_0 == "table") then
...
do
  ...
  package.preload[module_name] = _805_
  _ = nil
  local env = nil
  do
    local _806_0 = specials["make-compiler-env"](nil, compiler.scopes.compiler, {})
    _806_0["utils"] = utils
    _806_0["fennel"] = mod
    _806_0["get-function-metadata"] = specials["get-function-metadata"]
    env = _806_0
  end
